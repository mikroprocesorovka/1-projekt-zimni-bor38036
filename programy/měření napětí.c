...
//3.Každé 2 sekundy odesílá na UART informaci o poloze potenciometru v procentech a hodnotì napìtí.
...
GPIO_Init(GPIOC,GPIO_PIN_1,GPIO_MODE_OUT_PP_LOW_SLOW); // inicializace pinu
...
void uart(void){
	...
	// každé 2 sekundy se informace vypíše pøes UART
	if(aktualni_cas - posledni_cas > 2000){
