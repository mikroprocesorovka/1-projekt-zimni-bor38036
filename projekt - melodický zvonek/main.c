...
Bìhem melodie se zobrazí obrázek (vıkøièník) na dotmatrixu.
...
if(i==1){
	...
	swspi_tx16(MAX7219_DIG0 | 0); 
	swspi_tx16(MAX7219_DIG1 | 0); 
	swspi_tx16(MAX7219_DIG2 | 0); 
	swspi_tx16(MAX7219_DIG3 | z); 
	swspi_tx16(MAX7219_DIG4 | z); 
	swspi_tx16(MAX7219_DIG5 | 0); 
	swspi_tx16(MAX7219_DIG6 | 0); 
	swspi_tx16(MAX7219_DIG7 | 0); 
